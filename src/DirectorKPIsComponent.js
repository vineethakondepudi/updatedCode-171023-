...
export default function DirectorKPIsComponent() {
    ...
    useEffect(() => {
      fetch('http://172.17.15.253:8080/AdminDirectorGet')
    ...
    const handleFormSubmit = (e) => {
      ...
      fetch('http://172.17.15.253:8080/AdminDirectorPost', {
        method: 'POST',
        headers: {
    ...
    const handleDeleteKPI = (e) => {
      ...
      let adminDirectorDeleteURL = `http://172.17.15.253:8080/AdminDirectorDelete/${adminId}`;
